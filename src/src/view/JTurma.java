...
public class JTurma extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        controllerTurma.setArquivo("Abrir");
        controllerTurma.lerTurma();
        indice = 0;
        Navega(indice);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
            controllerTurma.setArquivo("salvar");
            controllerTurma.escreverTurma(true);
            JOptionPane.showMessageDialog(null, "Turma adicionado com sucesso!", 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        alterarTurmaPorCampos();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            controllerTurma.excluirTurma(Integer.parseInt(jTextFieldCodigo.getText()));
    ...
    public void Navega(int indice){
        try {
            Turma alu = controllerTurma.getTurmas().get(indice);
            jTextFieldNome.setText(alu.getNome());
            jTextFieldCodigo.setText(Integer.toString(alu.getCodigo()));
            jTextFieldTurma.setText(alu.getAlunos());
        } catch (Exception e) {
    ...
    public void adicionarTurma() {
        try {
            ...
            alu.setCodigo(Integer.parseInt(jTextFieldCodigo.getText()));
            alu.setAlunos(jTextFieldTurma.getText());
            controllerTurma.getTurmas().add(alu);
    ...
    public void alterarTurmaPorCampos() {
        try {
            String nome = jTextFieldNome.getText();
            int matricula = Integer.parseInt(jTextFieldCodigo.getText());
            String turma = jTextFieldTurma.getText();

            boolean alterado = controllerTurma.alterarTurma(matricula, nome, matricula, turma);

            if (alterado) {
                JOptionPane.showMessageDialog(null, "Turma alterado com sucesso!", 
                                              "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Turma com matrícula " + matricula + " não encontrado.", 
                                              "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException e) {
